...
{
    /// <summary>
    /// Gets the service provider from a <see cref="IServiceScope"/> of the application under test.
    /// </summary>
    /// <remarks>
...
where TEntryPoint : class
{
    ...
    /// <summary>
    /// Initializes a new instance of <see cref="AppServicesFixture{TEntryPoint}"/> that will create an async service scope
